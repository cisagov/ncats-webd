"""
This is the setup module for the ncats-webd project.
...
setup(
    ...
    version=get_version("src/ncats_webd/_version.py"),
    ...
    download_url="https://github.com/cisagov/ncats-webd",
    # Author details
    ...
    # Conveniently allows one to run the CLI tool as `ncats-webd`
